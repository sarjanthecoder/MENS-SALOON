        ...
        <div className="booking-layout">
          ...
          <div className="reveal">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '32px' }}>
              <div style={{ background: 'var(--white)', border: '1.5px solid var(--gold-border-light)', borderRadius: '18px', padding: '18px', display: 'flex', alignItems: 'center', gap: '16px', boxShadow: 'var(--shadow-card)' }}>
                <div style={{ width: '42px', height: '42px', borderRadius: '12px', background: 'var(--gold-pale)', border: '1px solid var(--gold-border)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--gold-deep)' }}>
                ...
                <div>
                  <div style={{ color: 'var(--text-dark)', fontWeight: '700', fontSize: '15px' }}>Lounge Timings</div>
              ...
              <div style={{ background: 'var(--white)', border: '1.5px solid var(--gold-border-light)', borderRadius: '18px', padding: '18px', display: 'flex', alignItems: 'center', gap: '16px', boxShadow: 'var(--shadow-card)' }}>
                ...
                <div>
                  <div style={{ color: 'var(--text-dark)', fontWeight: '700', fontSize: '15px' }}>Instant WhatsApp VIP Desk</div>
                  <div style={{ color: 'var(--text-muted)', fontSize: '13px' }}>+91 98000 12345 (Direct Concierge)</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="booking-card reveal reveal-delay-1">
            {submitted ? (
              <div style={{ textAlign: 'center', padding: '30px 10px' }}>
                <div style={{ width: '64px', height: '64px', borderRadius: '50%', background: 'var(--gold-pale)', border: '2px solid var(--gold-primary)', color: 'var(--gold-deep)', fontSize: '28px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}>
                  ✓
                </div>
                <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '24px', color: 'var(--text-dark)', marginBottom: '10px' }}>
                  VIP Reservation Confirmed
                </h3>
                <p style={{ color: 'var(--text-body)', fontSize: '14.5px', lineHeight: '1.7', marginBottom: '24px' }}>
              ...
              <form onSubmit={handleSubmit} noValidate>
                <div style={{ marginBottom: '24px' }}>
                  <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '22px', color: 'var(--text-dark)' }}>
                ...
                <div className="form-row">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      className="form-input" placeholder="+91 98000 12345"
