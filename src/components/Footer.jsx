    ...
    <footer className="footer-luxe">
      <div className="container">
        <div className="footer-grid">
          {/* Brand */}
          <div>
            <div className="footer-brand-name">SHANKARA</div>
            <div className="footer-brand-tag">Luxury Men&apos;s Salon &amp; Grooming Lounge</div>
            <p className="footer-brand-desc">
              Bespoke hair architecture, royal hot towel straight-razor detailing, and rejuvenating wellness therapies for the distinguished gentleman.
            </p>
            <div style={{ marginTop: '24px', display: 'flex', gap: '14px' }}>
              <a href="tel:+919800012345" aria-label="Call lounge concierge" style={{ width: '40px', height: '40px', borderRadius: '12px', background: 'var(--gold-pale)', border: '1px solid var(--gold-border)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--gold-deep)', textDecoration: 'none' }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                </svg>
              </a>
              <a href="https://wa.me/919800012345" target="_blank" rel="noreferrer" aria-label="WhatsApp lounge concierge" style={{ width: '40px', height: '40px', borderRadius: '12px', background: 'var(--gold-pale)', border: '1px solid rgba(37,211,102,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#25D366', textDecoration: 'none' }}>
          ...
          <div>
            ...
            <div className="footer-links">
              {['Bespoke Hair Architecture', 'Royal Hot Towel Shave', 'Kérastase Scalp Detox', '24K Gold Detan Facial', 'Grand Groom Wedding Royale', 'Men’s Hand & Foot Spa'].map((t) => (
                <a key={t} href="#services" onClick={(e) => { e.preventDefault(); scrollTo('services') }}>{t}</a>
              ))}
            </div>
          </div>
          ...
          {/* Direct Contact */}
          <div>
            <div className="footer-col-title">Concierge Desk</div>
            <div className="footer-links">
              <a href="tel:+919800012345">+91 98000 12345</a>
              <a href="tel:+919800067890">+91 98000 67890</a>
              <span style={{ color: 'var(--text-muted)', fontSize: '13px', lineHeight: '1.6', marginTop: '6px', display: 'block' }}>
                #42, 2nd Level, The Grand Promenade,<br />
                Central Avenue, Luxury Boulevard,<br />
                Metro City – 600001
              </span>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          ...
          <span>© 2026 Shankara Luxury Men&apos;s Salon &amp; Grooming Lounge. All rights reserved.</span>
        </div>
      </div>
    </footer>
  )
