    ...
    <section className="contact-section-modern" id="contact">
      <div className="container">
        <div className="contact-section-header">
          <span className="section-eyebrow">Clinic Details & Map</span>
          <h2 className="section-title-dark" style={{ marginBottom: '14px' }}>
            Visit Shankara Dental Clinic.
          </h2>
          <p className="contact-section-subtitle">
            Conveniently located at the 4 Roads junction in Dharmapuri with accessible parking and elevator access.
          </p>
        </div>
        ...
        <div className="contact-grid-modern">
          ...
          <div className="contact-cards-container">
            ...
            <div className="contact-card-item">
              ...
              <div className="contact-card-content">
                <div className="contact-card-title">Clinic Location</div>
            ...
            <div className="contact-card-item">
              ...
              <div className="contact-card-content">
                <div className="contact-card-title">Direct Helplines</div>
                <div className="contact-card-phones">
                  <a href="tel:+916374253113" className="contact-phone-link">
                    <span>63742 53113</span>
                  </a>
                  <span className="divider-slash">/</span>
                  <a href="tel:+919843366992" className="contact-phone-link">
                    <span>98433 66992</span>
                  </a>
                </div>
                <div className="contact-card-phones secondary">
                  <a href="tel:+918618002904" className="contact-phone-link">
                    <span>86180 02904</span>
                  </a>
                  <span className="divider-slash">/</span>
                  <a href="tel:+917910250263" className="contact-phone-link">
                    <span>79102 50263</span>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="contact-card-item">
              ...
              <div className="contact-card-content">
                <div className="contact-card-title">Consultation Hours</div>
                <div className="contact-card-schedule">
                  <div className="schedule-row">
                    <span className="sched-day">Mon – Sat:</span>
                    <span className="sched-time">9:00 AM – 8:00 PM</span>
                  </div>
                  <div className="schedule-row">
                    <span className="sched-day">Sunday:</span>
                    <span className="sched-time">Prior Appointment Only</span>
                  </div>
                </div>
              </div>
            </div>

            {/* WhatsApp Card with Official Logo */}
            <div className="contact-card-item highlight-card">
              <div className="contact-card-icon-box wa">
              ...
              <div className="contact-card-content">
                <div className="contact-card-title">Instant WhatsApp Help</div>
                <p style={{ fontSize: '13px', color: 'var(--gray-600)', marginBottom: '8px' }}>
                  Send photos or questions directly to our reception desk.
                </p>
                <a
          ...
          <div className="contact-map-wrapper">
            <div className="contact-map-card">
              <iframe
                title="Shankara Dental Clinic Location Map"
                ...
                aria-label="Shankara Dental Clinic map location"
              />
              <div className="map-overlay-badge">
                <div className="map-badge-text">
                  <strong>Shankara Dental Clinic</strong>
                  <span>Pennagaram Road, Dharmapuri</span>
                </div>
                <a
