      ...
      <div className="container">
        <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto' }} className="reveal">
          ...
          <p className="section-subtitle" style={{ margin: '0 auto' }}>
            Centrally situated at the Grand Promenade with private valet parking and private elevator access.
          </p>
        </div>
        ...
        <div className="contact-grid">
          ...
          <div className="reveal">
            ...
            <div className="contact-card-item">
              ...
              <div>
                <div style={{ fontFamily: 'var(--font-display)', fontSize: '18px', fontWeight: '700', color: 'var(--text-dark)' }}>
                  Lounge Location
                </div>
                <div style={{ color: 'var(--text-body)', fontSize: '14px', marginTop: '4px', lineHeight: '1.6' }}>
                  <strong>#42, 2nd Level, The Grand Promenade</strong><br />
                  Central Avenue, Luxury Boulevard,<br />
                  Metro District, City – 600001
                </div>
              </div>
            </div>
            ...
            <div className="contact-card-item">
              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: '10px', marginTop: '6px', flexWrap: 'wrap' }}>
                  <a href="tel:+919800012345" style={{ color: 'var(--gold-deep)', textDecoration: 'none', fontWeight: '700' }}>
                    +91 98000 12345
                  </a>
                  <span style={{ color: 'var(--gold-border)' }}>/</span>
                  <a href="tel:+919800067890" style={{ color: 'var(--gold-deep)', textDecoration: 'none', fontWeight: '700' }}>
                    +91 98000 67890
                  </a>
                </div>
            ...
            {/* WhatsApp VIP Card */}
            <div className="contact-card-item" style={{ border: '1.5px solid rgba(37,211,102,0.4)', background: 'rgba(37,211,102,0.05)' }}>
              ...
              <div>
                ...
                <div style={{ color: 'var(--text-body)', fontSize: '13.5px', marginTop: '2px', marginBottom: '8px' }}>
